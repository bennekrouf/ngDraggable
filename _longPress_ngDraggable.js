                ...
                link: function (scope, element, attrs) {
                  ...
                  //  return;
                    ...
                    var toggleListeners = function (enable) {
                        ...
                        element.on(_leaveEvent, onleave);
                    ...
                    var onlongpress = function(evt) {
                        ...
                        var timish =  new Date().getTime();
                       // console.log("timish : / start+longpress : ", timish, start+longpress);

                        if ( timish >= ( start + longpress )  ) { // Long press = start drag
                            // console.log('long press in longpressfunction!');
...
*/                            $rootScope.$broadcast('draggable:start', {x:_mx, y:_my, tx:_tx, ty:_ty, event:evt, element:element, data:_data});
                           ...
                           // console.log('short press in longpressfunction!');   
                        }
                    ...
                    var onrelease = function(evt) {
                       ...
                       //  console.log("start in onrelease: ", start);
